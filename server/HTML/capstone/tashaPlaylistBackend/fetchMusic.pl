...
my $musicDirectory = 'C:\Program Files\Squeezebox\server\HTML\capstone\tashaPlaylistBackend\testMusic'; # Note: Forward slashes or double backslashes are required for Windows paths.

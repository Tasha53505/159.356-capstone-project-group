package Slim::Plugin::CapstoneSettings::AdvancedFormatting;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_FORMATTING_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedFormatting.html');
}

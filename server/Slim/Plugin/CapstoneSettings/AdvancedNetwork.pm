package Slim::Plugin::CapstoneSettings::AdvancedNetwork;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_NETWORK_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedNetwork.html');
}

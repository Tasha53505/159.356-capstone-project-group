package Slim::Plugin::CapstoneSettings::AdvancedSoftwareUpdate;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_SOFTWARE_UPDATE_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedSoftwareUpdate.html');
}

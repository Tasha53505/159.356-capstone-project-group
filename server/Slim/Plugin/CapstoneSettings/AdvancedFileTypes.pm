package Slim::Plugin::CapstoneSettings::AdvancedFileTypes;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_FILEFORMATS_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedFileTypes.html');
}

package Slim::Plugin::CapstoneSettings::AdvancedSecurity;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_SECURITY_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedSecurity.html');
}

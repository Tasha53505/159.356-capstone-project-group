package Slim::Plugin::CapstoneSettings::AdvancedLogging;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_LOGGING_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedLogging.html');
}

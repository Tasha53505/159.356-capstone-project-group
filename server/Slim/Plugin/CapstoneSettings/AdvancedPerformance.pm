package Slim::Plugin::CapstoneSettings::AdvancedPerformance;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('ADVANCED_PERFORMANCE_SETTINGS');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CapstoneSettings/advancedPerformance.html');
}
